...
cd the-desk
git fetch --tags
git checkout v1.4.0 # x-release-please-version         (the desired release tag)
...
git clone git@github.com:emmpaul/the-desk.git
cd the-desk
git fetch --tags && git checkout v1.4.0 # x-release-please-version   (the desired release tag)
...
echo 'APP_IMAGE=ghcr.io/emmpaul/the-desk:1.4.0' >> .env # x-release-please-version
